...
data\_val{[}`Family\_Size'{]}=data\_val{[}`SibSp'{]}+data\_val{[}`Parch'{]}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}32}]:} \PY{n}{data1}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{l+m+mi}{10}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}32}]:}    Survived  Pclass  Sex  Age  SibSp  Parch  Fare  Embarked
         0         0       2    1   29      1      0    18         2
         1         1       0    0   56      1      0   207         0
         2         1       2    0   35      0      0    41         2
         3         1       0    0   52      1      0   189         2
         4         0       2    1   52      0      0    43         2
         5         0       2    1   36      0      0    51         1
         6         0       0    1   75      0      0   186         2
         7         0       2    1    6      3      1   124         2
         8         1       2    0   37      0      2    74         2
...
'\texttt{MIN\_MAX\_SCALER\textquotesingle{}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}33}]:} \PY{k+kn}{import} \PY{n+nn}{vs} \PY{k}{as} \PY{n+nn}{vs2}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}34}]:} \PY{n}{vs2}\PY{o}{.}\PY{n}{distribution}\PY{p}{(}\PY{n}{data1}\PY{p}{)}
\end{Verbatim}
...
other variable. So to make the features in equal distribution we had
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}35}]:} \PY{n}{data1}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{l+m+mi}{3}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}35}]:}    Survived  Pclass  Sex  Age  SibSp  Parch  Fare  Embarked
         0         0       2    1   29      1      0    18         2
         1         1       0    0   56      1      0   207         0
         2         1       2    0   35      0      0    41         2
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}36}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{preprocessing} \PY{k}{import} \PY{n}{MinMaxScaler}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
/home/guriboy/anaconda3/lib/python3.7/site-packages/sklearn/preprocessing/data.py:334: DataConversionWarning: Data with input dtype int64 were all converted to float64 by MinMaxScaler.
...
/home/guriboy/anaconda3/lib/python3.7/site-packages/sklearn/preprocessing/data.py:334: DataConversionWarning: Data with input dtype int64 were all converted to float64 by MinMaxScaler.
  return self.partial\_fit(X, y)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}37}]:} \PY{n}{data\PYZus{}val}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{l+m+mi}{5}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}37}]:}    Pclass  Sex       Age     SibSp     Parch      Fare  Embarked
         0     1.0  1.0  0.571429  0.000000  0.000000  0.142012       0.5
         1     1.0  0.0  0.785714  0.166667  0.000000  0.029586       1.0
         2     0.5  1.0  0.952381  0.000000  0.000000  0.242604       0.5
         3     1.0  1.0  0.440476  0.000000  0.000000  0.201183       1.0
         4     1.0  0.0  0.321429  0.166667  0.142857  0.272189       1.0
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}38}]:} \PY{n}{vs2}\PY{o}{.}\PY{n}{distribution}\PY{p}{(}\PY{n}{data1}\PY{p}{)}
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}39}]:} \PY{n}{plt}\PY{o}{.}\PY{n}{subplots}\PY{p}{(}\PY{n}{figsize} \PY{o}{=}\PY{p}{(}\PY{l+m+mi}{20}\PY{p}{,} \PY{l+m+mi}{10}\PY{p}{)}\PY{p}{)}
...
\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}39}]:} <matplotlib.legend.Legend at 0x7f6944edacf8>
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}40}]:} \PY{c+c1}{\PYZsh{}correlation heatmap of dataset}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}41}]:} \PY{n}{data1}\PY{o}{.}\PY{n}{head}\PY{p}{(}\PY{l+m+mi}{1}\PY{p}{)}
\end{Verbatim}

\begin{Verbatim}[commandchars=\\\{\}]
{\color{outcolor}Out[{\color{outcolor}41}]:}    Survived  Pclass  Sex       Age     SibSp  Parch      Fare  Embarked
         0         0     1.0  1.0  0.311828  0.166667    0.0  0.073171       1.0
\end{Verbatim}
            
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}42}]:} \PY{n}{Target} \PY{o}{=} \PY{p}{[}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{Survived}\PY{l+s+s2}{\PYZdq{}}\PY{p}{]}
...
Test y  Shape: (178, 1)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}43}]:} \PY{c+c1}{\PYZsh{}\PYZsh{} TILL Now we have analyzed the data well. ITS Time to make some predictions.}
\end{Verbatim}
...
\end{itemize}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}44}]:} \PY{n}{Target} \PY{o}{=} \PY{n}{data1}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{Survived}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}45}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{metrics} \PY{k}{import} \PY{n}{accuracy\PYZus{}score}
...
(KNeighbors) - Support Vector Machines (SVM) - Logistic Regression
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}46}]:} \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{metrics} \PY{k}{import} \PY{n}{fbeta\PYZus{}score}\PY{p}{,} \PY{n}{accuracy\PYZus{}score}
...
implementation may take some time to run!
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}47}]:} \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Quadratic Discriminant Analysis}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} Logistic Regression}
         \PY{c+c1}{\PYZsh{}\PYZsh{}\PYZsh{} KNN}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}48}]:} \PY{k+kn}{import} \PY{n+nn}{vs2} \PY{k}{as} \PY{n+nn}{vs}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}49}]:}  \PY{k+kn}{from} \PY{n+nn}{sklearn}\PY{n+nn}{.}\PY{n+nn}{discriminant\PYZus{}analysis} \PY{k}{import} \PY{n}{QuadraticDiscriminantAnalysis}
...
KNeighborsClassifier trained on 711 samples.
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}50}]:} \PY{n}{LR} \PY{o}{=} \PY{n}{results}\PY{p}{[}\PY{l+s+s1}{\PYZsq{}}\PY{l+s+s1}{LogisticRegression}\PY{l+s+s1}{\PYZsq{}}\PY{p}{]}\PY{p}{[}\PY{l+m+mi}{2}\PY{p}{]}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}51}]:} \PY{n+nb}{print}\PY{p}{(}\PY{n}{LR}\PY{p}{)}
...
\end{Verbatim}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
\{'train\_time': 0.009928464889526367, 'pred\_time': 0.0048084259033203125, 'acc\_train': 0.857, 'acc\_test': 0.713, 'f\_train': 0.802, 'f\_test': 0.653\}
-----------------
\{'train\_time': 0.006243228912353516, 'pred\_time': 0.005593061447143555, 'acc\_train': 0.87, 'acc\_test': 0.736, 'f\_train': 0.817, 'f\_test': 0.682\}
-----------------
\{'train\_time': 0.0061359405517578125, 'pred\_time': 0.0770263671875, 'acc\_train': 0.877, 'acc\_test': 0.736, 'f\_train': 0.855, 'f\_test': 0.684\}
...
\subsection{For kaggle prediction}\label{for-kaggle-prediction}}
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}52}]:} \PY{n}{Clf\PYZus{}KNN} \PY{o}{=} \PY{n}{clf\PYZus{}B}\PY{o}{.}\PY{n}{fit}\PY{p}{(}\PY{n}{train1\PYZus{}x}\PY{p}{,}\PY{n}{train1\PYZus{}y}\PY{p}{)}
\end{Verbatim}
...
/home/guriboy/anaconda3/lib/python3.7/site-packages/sklearn/utils/validation.py:761: DataConversionWarning: A column-vector y was passed when a 1d array was expected. Please change the shape of y to (n\_samples, ), for example using ravel().
  y = column\_or\_1d(y, warn=True)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}53}]:} \PY{n}{pred}  \PY{o}{=} \PY{n}{Clf\PYZus{}KNN}\PY{o}{.}\PY{n}{predict}\PY{p}{(}\PY{n}{data\PYZus{}val}\PY{p}{)}
\end{Verbatim}

    \begin{Verbatim}[commandchars=\\\{\}]
{\color{incolor}In [{\color{incolor}54}]:} \PY{n}{pred\PYZus{}KAGGLE\PYZus{}NEW} \PY{o}{=} \PY{n}{pd}\PY{o}{.}\PY{n}{DataFrame}\PY{p}{(}\PY{n}{pred}\PY{p}{)}
